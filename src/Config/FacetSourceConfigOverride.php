...
/**
 * Defines facet source configuration overrides.
 */
class FacetSourceConfigOverride extends StorableConfigBase  {

  /**
   * Constructs a facet source override object.
   *
   * @param string $name
  ...
  public function save($has_trusted_data = FALSE) {
    ...
    $this->isNew = FALSE;
    $this->eventDispatcher->dispatch(FacetSourceConfigOverrideEvents::SAVE_OVERRIDE, new FacetSourceConfigOverrideCrudEvent($this));
  ...
  public function delete() {
    ...
    Cache::invalidateTags($this->getCacheTags());
    $this->isNew = TRUE;
    $this->eventDispatcher->dispatch(FacetSourceConfigOverrideEvents::DELETE_OVERRIDE, new FacetSourceConfigOverrideCrudEvent($this));
    $this->originalData = $this->data;
    return $this;
  }
